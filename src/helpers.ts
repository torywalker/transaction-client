 ...
 */
export const validateProperty = <T>(property: T, name: string, type: string | string[]): T => {
  if (
 ...
 * @param {Error} err
 */
export const getErrorMsg = (err?: Error | string) => (err instanceof Error ? err.message : err);
